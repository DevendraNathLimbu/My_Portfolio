...
export default function Skills() {
    ...
    <div className="w-full min-h-[10vh] flex flex-col items-center justify-center py-10">
        <h2 className="text-3xl md:text-5xl text-white font-semibold font-['headerFont']">SKILLS ⚔️</h2>

{/* This is a carousel for my skills */}
<div className="carousel mask-l-from-90% mask-l-to-100%  mask-r-from-80%">
    <div className="group gap-[4rem]">
        <div className="container h-auto w-auto flex flex-col items-center justify-center gap-2">
            <div className="box h-[50px] w-[50px] md:h-[70px] md:w-[70px] bg-[url('./assets/icons/html.png')] bg-cover bg-center"></div>
            <h5 className="md:text-xl text-white font-semibold">HTML</h5>
        </div>
        <div className="container h-auto w-auto flex flex-col items-center justify-center gap-2">
            <div className="box h-[50px] w-[50px] md:h-[70px] md:w-[70px] bg-[url('./assets/icons/css.png')] bg-cover bg-center"></div>
